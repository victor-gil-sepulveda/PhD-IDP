...
results = tools.load_dic_in_json(os.path.join("RDCvsRMSD", "campari", "RDC", "clustering","results","results.json"))
RDC_clustering = Clustering.from_dic(results["selected"][results["best_clustering"]]["clustering"]).gen_class_list()
print results["selected"][results["best_clustering"]]["clustering"]["number_of_clusters"]

results = tools.load_dic_in_json(os.path.join("RDCvsRMSD", "campari", "RMSD", "clustering","results","results.json"))
RMSD_clustering = Clustering.from_dic(results["selected"][results["best_clustering"]]["clustering"]).gen_class_list()

print results["selected"][results["best_clustering"]]["clustering"]["number_of_clusters"]

print sklearn.metrics.adjusted_rand_score(RDC_clustering,RMSD_clustering)
print sklearn.metrics.adjusted_rand_score(RMSD_clustering,RDC_clustering)
